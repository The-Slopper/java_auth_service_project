# Especificacao Tecnica — Java Auth Service

| Field | Value |
|---|---|
| Repository | `java_auth_service_project` |
...
Iofntity and access service: tokens, sessions, and permissions. This document describes requirements, architecture, and acceptance criteria.
