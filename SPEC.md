...
| Campo | Valor |
|---|---|
| Repositorio | `java_auth_service_project` |
...
Servico de identidade e acesso: tokens, sessoes e permissoes. Este documento descreve requisitos, arquitetura e criterios de aceite.
